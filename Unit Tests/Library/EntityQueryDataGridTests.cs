...
[TestClass]
public class EntityQueryDataGridTests : TestBase
{
    [TestMethod]
    public void Test()
    {
        string mySelectQuery = "SELECT Name, ActivityConfigName FROM `activity__master`";
...
// Always call Read before accessing data.
        ...
        var entityData = new EntityQueryDataGrid(ScriptEngine);
